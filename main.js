...
browser: ['Apanya-Bot','Safari','1.0.0']
}
...
conn.welcome = '*╔══════════════*\n*╟❧ @subject*\n*╠══════════════*\n*╟❧ @user*\n*╟❧ selamat datang/A* \n*║*\n*╟❧ deskripsi grup:*\n*╟❧* @desc\n*║*\n*╟❧ Selamat Bergabung!!*\n*╚══════════════*'
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ sampai jumpa 👋🏻* \n*╚══════════════*'
conn.spromote = '*@user bergabung dengan grup admin!!*'
conn.sdemote = '*@user Keluar dari grup admin !!*'
conn.sDesc = '*Deskripsi grup telah diubah*\n\n*deskripsi baru:* @desc'
conn.sSubject = '*Nama grup telah diubah*\n*nama baru:* @subject'
conn.sIcon = '*foto grup berubah!!*'
conn.sRevoke = '*Tautan grup telah diperbarui!!*\n*Link Baru:* @revoke'
